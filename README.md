...
| Day 1 | 2025-06-24 | 기본 폴더 구조 정리, Favicon 및 로고 적용  |
| Day 2 | 2025-06-26 | Supabase + Google OAuth 로그인 연동        |
| Day 3 | 2025-06-27 | 전역 로그인 상태 관리 및 라우팅 분기       |
| Day 4 | 2025-06-30 | 글 입력 UI 및 요약 요청 기능 구현          |
| Day 5 | 2025-07-01 | 요약 결과 출력 화면 구현                   |
| Day 6 | 2025-07-02 | 감정 분석 및 감정별 피드백 구성            |
| Day 7 | 2025-07-03 | 요약 및 감정 기록 저장 기능                |
| Day 8 | 2025-07-04 | 마이페이지 구조 구현 (내 기록, 그룹 등)    |
| Day 9 | 2025-07-07 | PWA 앱 설치 테스트 및 배포 준비            |
