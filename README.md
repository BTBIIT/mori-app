...
| Day 18 | 7/18 (금) | 예정      | - DiaryWrite / ResultDaily UI 리팩토링 Day 1<br>- 모바일 대응 구조 정리                                                             | ✅ 완료 |
| Day 19 | 7/21 (월) | 예정      | - DiaryWrite / ResultDaily UI 리팩토링 Day 2(로고위치)<br>- 열람 기능 기능 연동 시작                                                | ⏳ 예정 |
